...
from geoquaksapp.models import Quake , Quake_Predections
#import models.Quake
...
if Quake.objects.all().count()==0 :
    ...
    df = pd.read_csv(r"geoquaksapp\database.csv")
    # preview df
    #print(df.head())
...
if Quake_Predections.objects.all().count()==0:
    ...
    df_test = pd.read_csv(r"geoquaksapp\earthquakeTest.csv.txt")
    df_train = pd.read_csv(r"geoquaksapp\database.csv")
